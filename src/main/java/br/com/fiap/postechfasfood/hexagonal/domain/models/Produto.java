...
public class Produto {
    ...
    public Produto(String cdProduto, String nmProduto, String dsDescricao, double vlPreco, boolean snAtivo,
    ...
    public static class Builder {
        ...
        public Produto build() {
            return new Produto(cdProduto, nmProduto, dsDescricao, vlPreco, snAtivo, tpCategoria);
        }
    }
